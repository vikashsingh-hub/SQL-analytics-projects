...
we made the most money. wrrite a query that returns one city that has the highest sum of invoice totals.
...
Q1: write query to return the email, first name, last name, & Genre of all Rock Music listeners. Return 
...
where the top amount spent is shared, provide all customers who spent his amount
